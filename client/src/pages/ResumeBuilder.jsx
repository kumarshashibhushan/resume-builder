...
const ResumeBuilder = () => {
  ...
  const saveResume = async () => {
    try {
      ...
      // Remove accidentally added singular 'project' field if present
      if (Object.prototype.hasOwnProperty.call(updatedResumeData, "project")) {
        delete updatedResumeData.project;
      }

      // If personal image is a File object, strip it from JSON and append separately
